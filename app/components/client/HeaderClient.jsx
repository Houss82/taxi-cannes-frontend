...
export default function HeaderClient({ navItems, children }) {
      ...
      {isMobileMenuOpen && (
        <>
          <motion.div
            ...
            className="md:hidden fixed inset-0 z-200 cursor-pointer bg-black/20 backdrop-blur-sm"
          ...
          <motion.div
            ...
            className="md:hidden fixed top-0 right-0 bottom-0 w-full max-w-md z-201 bg-linear-to-br from-white to-gray-50 border-l border-gray-200 shadow-2xl flex flex-col min-h-0 pt-16"
          >
            <motion.div
            ...
            >
              <div className="flex items-center justify-between">
                <div className="flex items-center space-x-3 min-w-0">
                  <div className="flex h-12 w-12 shrink-0 items-center justify-center rounded-xl bg-accent shadow-lg">
  ...
  return (
    <>
      ...
      >
        <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between relative isolate">
          <div
            className={
              isScrolled
          ...
          <button
            ...
            className="relative z-20 md:hidden flex items-center gap-2 px-2.5 sm:px-3 py-2 rounded-lg hover:bg-white/10 transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2"
