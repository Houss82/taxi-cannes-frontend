...
/**
 * Bandeau CTA appel + réservation — mobile uniquement, visible après scroll sur l’accueil.
 * Comportement aligné sur le projet Taxi Marseille.
 */
  ...
  return (
    <AnimatePresence>
      {isVisible && (
        <motion.div
          key="mobile-cta"
          className="fixed inset-x-0 bottom-0 z-50 pointer-events-none md:hidden"
          role="complementary"
        ...
        >
          <div className="pointer-events-none mx-auto max-w-lg px-3 pt-2">
            ...
            >
              {!reduce && <div className="mobile-cta-aurora-blob" aria-hidden />}
              <div
                className="pointer-events-none absolute inset-0 rounded-[1.35rem] opacity-80"
                aria-hidden
                style={{
                  background:
                    "linear-gradient(135deg, rgba(59,130,246,0.1) 0%, transparent 50%, rgba(5,150,105,0.08) 100%)",
                }}
              />
              <div className="relative z-1">
                ...
                <div className="flex gap-2.5">
                  <motion.a
                    href={SITE_PHONE_TEL}
                    className={`group relative flex min-h-[3.35rem] flex-1 items-center gap-2.5 overflow-hidden rounded-2xl px-3 py-2 text-white shadow-lg shadow-emerald-600/25 ${!reduce ? "mobile-cta-call-bg" : "bg-linear-to-br from-emerald-600 via-teal-600 to-sky-700"}`}
                  ...
                  >
                    ...
                    <span className="relative z-1 min-w-0 flex-1 text-left">
                      <span className="block text-[0.7rem] font-medium text-emerald-50">
                        Appeler maintenant
                      </span>
                  ...
                  >
                    ...
                    >
                      ...
                      >
                        <Calendar
                          className="h-[1.15rem] w-[1.15rem] text-sky-600"
                          strokeWidth={2}
                          aria-hidden
                        />
