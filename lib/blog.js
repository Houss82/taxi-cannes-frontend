...
// Récupérer tous les articles du blog (sans conversion HTML pour la liste)
      ...
      .map((fileName) => {
        try {
          ...
          return {
            ...
            image: metadata.image || "/bg-image.png",
            category: metadata.category || "Actualités",
            author: metadata.author || "Taxi Cannes",
...
// Récupérer un article par son slug avec conversion HTML
